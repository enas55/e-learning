...
function JoinedCourses() {
    ...
    const t = translations[language].joinedCourses;
    const pageNameT = translations[language].pageNames;
    const location = useLocation();

    useEffect(() => {
        document.title = pageNameT.Joined_Courses_Page;
    }, [location, pageNameT]);
    ...
    return (
        <Container maxWidth="lg" sx={{ marginTop: 4, marginBottom: 6 }}>
            ...
            <Typography variant="h3" sx={{ marginBottom: 4, textAlign: "center", color: "#1C1E53"}}>
                {t.Joined_Courses_Title}
            </Typography>
